...
public class ValidaTicketRecargasPuntosBA implements Task {

    private List<Transferencias> transferencias;

    public ValidaTicketRecargasPuntosBA(List<Transferencias> transferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        Scroll.to(CELULAR_TICKET_CEL).andAlignToTop().performAs(actor);
        ...
        Scroll.to(COMPANIA_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(PAQUETEMONTO_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(CONCEPTO_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(DESDE_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        Task.where(actor+" valida que 'Desde' se muestre", WaitUntil.the(DESDE_TICKET_CEL, isVisible()).forNoMoreThan(1).seconds()).performAs(actor);
        Scroll.to(ESTADO_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(FECHAORDENANZA_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(FECHAAPLICADA_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
        ...
        Scroll.to(IDTRANSACCION_TICKET_CEL).andAlignToTop().performAs(actor);
        LeerArchivoProperties.esperar2();
    ...
    public static ValidaTicketRecargasPuntosBA datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(ValidaTicketRecargasPuntosBA.class).withProperties(transferencias);
    }
}
