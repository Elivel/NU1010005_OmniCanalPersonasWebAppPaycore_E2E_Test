...
public class RealizarPagoTarjetaCreditoPropiaCuentas implements Task {
    private List<Transferencias> datostransferencias;

    public RealizarPagoTarjetaCreditoPropiaCuentas(List<Transferencias> datostransferencias) {
    ...
    public static RealizarPagoTarjetaCreditoPropiaCuentas datosCompletos(List<Transferencias> datosTransferencias) {
        return Instrumented.instanceOf(RealizarPagoTarjetaCreditoPropiaCuentas.class).withProperties(datosTransferencias);
    }
}
