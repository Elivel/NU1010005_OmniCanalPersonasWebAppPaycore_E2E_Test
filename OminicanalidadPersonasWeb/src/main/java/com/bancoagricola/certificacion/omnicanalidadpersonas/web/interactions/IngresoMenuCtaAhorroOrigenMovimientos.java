...
public class IngresoMenuCtaAhorroOrigenMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;

    public IngresoMenuCtaAhorroOrigenMovimientos(List<Transferencias> datosDCA) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(OPCION_MENU.of(CUENTAS), isVisible()).forNoMoreThan(60).seconds(),
                ...
                WaitUntil.the(TTL_RS_CAyCC.of(t.getTituloCuenta()), isVisible()).forNoMoreThan(60).seconds(),
                WaitUntil.the(TTL_RS_CAyCC.of(t.getTituloCuenta()), isEnabled()).forNoMoreThan(60).seconds());
    ...
    public static IngresoMenuCtaAhorroOrigenMovimientos inicio(List<Transferencias> datosTransferencias) {
        return Instrumented.instanceOf(IngresoMenuCtaAhorroOrigenMovimientos.class).withProperties(datosTransferencias);
    }
}
