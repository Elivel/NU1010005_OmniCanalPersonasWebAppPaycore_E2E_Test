...
public class IngresoMenuCAOrigenMovBasico implements Interaction {

    private String cuenta;
    public IngresoMenuCAOrigenMovBasico(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public static IngresoMenuCAOrigenMovBasico inicio(String cuenta) {
        return Instrumented.instanceOf(IngresoMenuCAOrigenMovBasico.class).withProperties(cuenta);
    }
}