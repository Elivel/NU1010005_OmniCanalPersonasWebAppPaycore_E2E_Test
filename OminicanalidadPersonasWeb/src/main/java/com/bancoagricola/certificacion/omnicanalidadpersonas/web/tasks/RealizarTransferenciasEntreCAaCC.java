...
public class RealizarTransferenciasEntreCAaCC implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciasEntreCAaCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciasEntreCAaCC cuentasPropias(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciasEntreCAaCC.class).withProperties(datostransferencias);
    }
