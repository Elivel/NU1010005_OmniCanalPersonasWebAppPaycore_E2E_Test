...
public class RealizarTransferenciaTerceroFavoritoADS implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroFavoritoADS(List<Transferencias> datostransferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(OPCIONES_TRANSFERIR_CTA_DES.of(t.getCuentaTercero()), isEnabled()).forNoMoreThan(60).seconds(),
                WaitUntil.the(OPCIONES_TRANSFERIR_CTA_DES.of(t.getCuentaTercero()), isClickable()).forNoMoreThan(60).seconds(),
                Click.on(OPCIONES_TRANSFERIR_CTA_DES.of(t.getCuentaTercero())),
    ...
    public static RealizarTransferenciaTerceroFavoritoADS favorito(List<Transferencias> datostransferencias) {

        return Instrumented.instanceOf(RealizarTransferenciaTerceroFavoritoADS.class).withProperties(datostransferencias);
    }
}