...
public class IngresoMenuCCOrigenMovBasico implements Interaction {

    private String cuenta;
    public IngresoMenuCCOrigenMovBasico(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public static IngresoMenuCCOrigenMovBasico inicio(String cuenta){
        return Instrumented.instanceOf(IngresoMenuCCOrigenMovBasico.class).withProperties(cuenta);
    }
}
