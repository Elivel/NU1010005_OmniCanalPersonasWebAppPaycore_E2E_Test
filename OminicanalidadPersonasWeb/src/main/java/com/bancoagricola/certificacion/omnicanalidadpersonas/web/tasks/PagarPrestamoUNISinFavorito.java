...
public class PagarPrestamoUNISinFavorito implements Task {
    private List<Transferencias> datosCAP;

    public PagarPrestamoUNISinFavorito(List<Transferencias> datosCAP) {
    ...
    public static PagarPrestamoUNISinFavorito datosP(List<Transferencias> datosCAP) {
        return Instrumented.instanceOf(PagarPrestamoUNISinFavorito.class).withProperties(datosCAP);
    }
}
