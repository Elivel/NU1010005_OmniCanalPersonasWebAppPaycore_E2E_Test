...
public class RecargaConFavoritoPuntosBA implements Task {
    private List<Transferencias> datosDCA;

    public RecargaConFavoritoPuntosBA(List<Transferencias> datosDCA) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(SELECC_FAVOR, isEnabled()).forNoMoreThan(60).seconds(),
        ...
        actor.attemptsTo(
                ValidaTicketRecargasPuntosBAFavorito.datosCorrectos(datosDCA));
    }

    public static RecargaConFavoritoPuntosBA datosCA(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(RecargaConFavoritoPuntosBA.class).withProperties(datosDCA);
    }
}