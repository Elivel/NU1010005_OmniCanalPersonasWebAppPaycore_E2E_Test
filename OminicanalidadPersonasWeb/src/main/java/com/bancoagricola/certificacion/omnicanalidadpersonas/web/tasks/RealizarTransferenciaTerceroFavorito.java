...
public class RealizarTransferenciaTerceroFavorito implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroFavorito(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaTerceroFavorito favorito(List<Transferencias> datostransferencias) {

        return Instrumented.instanceOf(RealizarTransferenciaTerceroFavorito.class).withProperties(datostransferencias);
    }
}