...
public class CapturarSaldoCtaOrigenDestinoADSaCA implements Task {

    private List<Transferencias> datostransferencias;

    public CapturarSaldoCtaOrigenDestinoADSaCA(List<Transferencias> datostransferencias) {
    ...
    public static CapturarSaldoCtaOrigenDestinoADSaCA inicio(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(CapturarSaldoCtaOrigenDestinoADSaCA.class).withProperties(datostransferencias);
    }
