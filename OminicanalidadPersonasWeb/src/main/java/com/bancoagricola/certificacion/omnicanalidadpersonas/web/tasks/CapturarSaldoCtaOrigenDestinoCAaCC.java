...
public class CapturarSaldoCtaOrigenDestinoCAaCC implements Task {

    private List<Transferencias> datostransferencias;

    public CapturarSaldoCtaOrigenDestinoCAaCC(List<Transferencias> datostransferencias) {
    ...
    public static CapturarSaldoCtaOrigenDestinoCAaCC inicio(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(CapturarSaldoCtaOrigenDestinoCAaCC.class).withProperties(datostransferencias);
    }
