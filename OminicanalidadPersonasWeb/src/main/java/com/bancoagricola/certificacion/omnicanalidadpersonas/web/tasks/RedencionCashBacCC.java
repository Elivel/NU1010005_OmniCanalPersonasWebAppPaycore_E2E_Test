...
public class RedencionCashBacCC implements Task {
    private List<Transferencias> datosDonacion;

    public RedencionCashBacCC(List<Transferencias> datosDonacion) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                IngresoMenuCtaCorrienteDestinoMovimientos.inicio(datosDonacion),
    ...
    public static RedencionCashBacCC datosCorrectos(List<Transferencias> datosDonacion) {
        return Instrumented.instanceOf(RedencionCashBacCC.class).withProperties(datosDonacion);
    }
}
