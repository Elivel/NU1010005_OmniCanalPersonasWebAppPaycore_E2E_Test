...
public class CapturarComprobante implements Task {
    private List<Transferencias> transferencias;
    public CapturarComprobante(List<Transferencias> transferencias) {
    ...
    public static CapturarComprobante datosC(List<Transferencias> datosCAP) {
        return Instrumented.instanceOf(CapturarComprobante.class).withProperties(datosCAP);
    }
}
