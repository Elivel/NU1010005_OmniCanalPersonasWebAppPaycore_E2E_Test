...
public class SeleccionarEnCalendarioFechaLista implements Interaction {
    ...
    public SeleccionarEnCalendarioFechaLista(List<Transferencias> datosDCA) {
    ...
    public static SeleccionarEnCalendarioFechaLista laFecha(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(SeleccionarEnCalendarioFechaLista.class).withProperties(datosDCA);
    }
}