...
public class IngresoMenuCtaCorrienteDestinoMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoMenuCtaCorrienteDestinoMovimientos(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public static IngresoMenuCtaCorrienteDestinoMovimientos inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoMenuCtaCorrienteDestinoMovimientos.class).withProperties(datosDCA);
    }
}
