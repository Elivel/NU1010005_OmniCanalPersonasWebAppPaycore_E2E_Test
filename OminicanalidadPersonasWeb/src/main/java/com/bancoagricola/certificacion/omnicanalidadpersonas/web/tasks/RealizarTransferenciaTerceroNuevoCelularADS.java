...
public class RealizarTransferenciaTerceroNuevoCelularADS implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroNuevoCelularADS(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaTerceroNuevoCelularADS nuevo(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciaTerceroNuevoCelularADS.class).withProperties(datostransferencias);
    }
}
