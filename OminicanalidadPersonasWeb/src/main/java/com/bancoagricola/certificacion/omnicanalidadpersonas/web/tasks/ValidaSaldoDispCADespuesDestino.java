...
public class ValidaSaldoDispCADespuesDestino implements Task {
    private List<Transferencias> datosCAP;
    public ValidaSaldoDispCADespuesDestino(List<Transferencias> datosCAP) {
    ...
    public static ValidaSaldoDispCADespuesDestino datosP(List<Transferencias> datosCAP) {
        return Instrumented.instanceOf(ValidaSaldoDispCADespuesDestino.class).withProperties(datosCAP);
    }
}
