...
public class ProcesoDeAgendaRecarga implements Task {
    private List<Transferencias> datosDCA;

    public ProcesoDeAgendaRecarga(List<Transferencias> datosDCA) {
    ...
    public static ProcesoDeAgendaRecarga datosCA(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(ProcesoDeAgendaRecarga.class).withProperties(datosDCA);
    }
}