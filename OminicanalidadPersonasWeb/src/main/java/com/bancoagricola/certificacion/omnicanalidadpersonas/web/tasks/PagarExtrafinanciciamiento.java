...
public class PagarExtrafinanciciamiento implements Task {
    private List<Transferencias> datostransferencias;

    public PagarExtrafinanciciamiento(List<Transferencias> datostransferencias) {
    ...
    public static PagarExtrafinanciciamiento cuentaPropia(List<Transferencias> datostransferencia) {
        return Instrumented.instanceOf(PagarExtrafinanciciamiento.class).withProperties(datostransferencia);
    }
}
