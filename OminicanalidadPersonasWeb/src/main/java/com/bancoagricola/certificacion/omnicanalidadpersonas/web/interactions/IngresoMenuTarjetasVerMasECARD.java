...
public class IngresoMenuTarjetasVerMasECARD implements Interaction {

    private List<Transferencias> datosTransferencias;

    public IngresoMenuTarjetasVerMasECARD(List<Transferencias> datosDCA) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(TTL_RESUMEN_ECARD, isCurrentlyVisible()).forNoMoreThan(60).seconds());
    }

    public static IngresoMenuTarjetasVerMasECARD inicio(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(IngresoMenuTarjetasVerMasECARD.class).withProperties(datosDCA);
    }
}