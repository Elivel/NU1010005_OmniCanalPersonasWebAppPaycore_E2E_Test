...
public class IngresoMenuCtaCorrienteOrigenMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoMenuCtaCorrienteOrigenMovimientos(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public static IngresoMenuCtaCorrienteOrigenMovimientos inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoMenuCtaCorrienteOrigenMovimientos.class).withProperties(datosDCA);
    }
}
