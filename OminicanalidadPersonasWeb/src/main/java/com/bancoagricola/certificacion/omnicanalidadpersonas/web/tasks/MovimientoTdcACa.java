...
public class MovimientoTdcACa implements Task {

    private List<Transferencias> datosTransferencias;

    public MovimientoTdcACa(List<Transferencias> datosFR) {
    ...
    public static MovimientoTdcACa datosM(List<Transferencias> datosM) {
        return Instrumented.instanceOf(MovimientoTdcACa.class).withProperties(datosM);
    }
}
