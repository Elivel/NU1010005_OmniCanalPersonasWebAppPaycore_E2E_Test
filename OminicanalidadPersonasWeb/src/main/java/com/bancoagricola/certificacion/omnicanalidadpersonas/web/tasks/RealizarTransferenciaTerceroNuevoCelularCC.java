...
public class RealizarTransferenciaTerceroNuevoCelularCC implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroNuevoCelularCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaTerceroNuevoCelularCC nuevo(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciaTerceroNuevoCelularCC.class).withProperties(datostransferencias);
    }
}
