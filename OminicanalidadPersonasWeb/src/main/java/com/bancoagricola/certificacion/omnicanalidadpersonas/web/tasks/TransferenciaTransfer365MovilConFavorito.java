...
public class TransferenciaTransfer365MovilConFavorito implements Task {
    private List<Transferencias> transferencias;

    public TransferenciaTransfer365MovilConFavorito(List<Transferencias> transferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Scroll.to(CONCEPTO_T365M).andAlignToTop(),
    ...
    public static TransferenciaTransfer365MovilConFavorito datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(TransferenciaTransfer365MovilConFavorito.class).withProperties(transferencias);
    }
}