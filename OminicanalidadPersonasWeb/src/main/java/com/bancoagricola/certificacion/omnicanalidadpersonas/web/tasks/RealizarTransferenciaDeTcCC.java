...
import static com.bancoagricola.certificacion.omnicanalidadpersonas.web.utils.CalculosTranferencias.obtenerMontoTarjetaFinal;
...
public class RealizarTransferenciaDeTcCC implements Task {
    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaDeTcCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaDeTcCC cuentaPropia(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciaDeTcCC.class).withProperties(datostransferencias);
    }
}
