...
public class RealizarPagoTarjetaCC implements Task {
    private List<Transferencias> datostransferencias;

    public RealizarPagoTarjetaCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarPagoTarjetaCC datosCompletos(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarPagoTarjetaCC.class).withProperties(datostransferencias);
    }
