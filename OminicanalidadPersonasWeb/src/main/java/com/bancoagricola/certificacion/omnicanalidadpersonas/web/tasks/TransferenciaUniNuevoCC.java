...
import static com.bancoagricola.certificacion.omnicanalidadpersonas.web.utils.Constantes.TRANSFERENCIA_ENTRE_BANCOS_EXITOSA;
...
public class TransferenciaUniNuevoCC implements Task {

    private List<Transferencias> transferencias;

    public TransferenciaUniNuevoCC(List<Transferencias> transferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                IngresoVerMasCtaCorriente.inicio(transferencias.get(0).getCuentaOrigen()),
    ...
    public static TransferenciaUniNuevoCC datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(TransferenciaUniNuevoCC.class).withProperties(transferencias);
    }
}
