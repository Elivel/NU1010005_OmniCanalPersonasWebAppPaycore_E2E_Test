...
public class IngresoMenuADSMovimientosBasico implements Interaction {

    private String cuenta;
    public IngresoMenuADSMovimientosBasico(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public static IngresoMenuADSMovimientosBasico inicio(String cuenta){
        return Instrumented.instanceOf(IngresoMenuADSMovimientosBasico.class).withProperties(cuenta);
    }
}
