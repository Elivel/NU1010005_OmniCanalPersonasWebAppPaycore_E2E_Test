...
public class RealizarTransferenciasEntreCAaCA implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciasEntreCAaCA(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciasEntreCAaCA cuentasPropias(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciasEntreCAaCA.class).withProperties(datostransferencias);
    }
