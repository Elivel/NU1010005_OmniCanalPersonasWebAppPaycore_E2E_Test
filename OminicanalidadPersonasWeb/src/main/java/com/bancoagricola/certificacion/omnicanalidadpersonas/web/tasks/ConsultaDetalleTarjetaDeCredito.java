...
public class ConsultaDetalleTarjetaDeCredito implements Task {
    private List<Transferencias> datosDCA;
    public ConsultaDetalleTarjetaDeCredito(List<Transferencias> datosDCA) {
        this.datosDCA = datosDCA;
    }

    @Step("{0} 'Consulta detalle de tarjeta de crédito'")
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(TTL_RESUMEN_TC, isEnabled()).forNoMoreThan(60).seconds(),
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(TTL_MAS_DETALLE_TDC, isCurrentlyVisible()).forNoMoreThan(60).seconds(),
    ...
    public static ConsultaDetalleTarjetaDeCredito datosCA(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(ConsultaDetalleTarjetaDeCredito.class).withProperties(datosDCA);
    }
}