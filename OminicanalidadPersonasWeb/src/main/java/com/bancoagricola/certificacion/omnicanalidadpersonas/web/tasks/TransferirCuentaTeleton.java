...
import com.bancoagricola.certificacion.omnicanalidadpersonas.web.interactions.IngresoMenuCAOrigenMovBasico;
...
public class TransferirCuentaTeleton implements Task {

    private String cuenta;
    private String monto;

    public TransferirCuentaTeleton(String cuenta, String monto) {
        this.cuenta = cuenta;
        this.monto = monto;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                IngresoMenuCAOrigenMovBasico.inicio(cuenta),
    ...
    public static TransferirCuentaTeleton datosCompletos(String cuenta, String monto) {
        return Instrumented.instanceOf(TransferirCuentaTeleton.class).withProperties(cuenta, monto);
    }
}
