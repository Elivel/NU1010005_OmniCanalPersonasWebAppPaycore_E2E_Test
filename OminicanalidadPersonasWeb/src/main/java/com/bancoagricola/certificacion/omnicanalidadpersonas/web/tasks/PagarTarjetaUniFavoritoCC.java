...
public class PagarTarjetaUniFavoritoCC implements Task {
    private List<Transferencias> transferencias;

    public PagarTarjetaUniFavoritoCC(List<Transferencias> transferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                IngresoMenuCtaCorrienteOrigenMovimientos.inicio(transferencias),
    ...
    public static PagarTarjetaUniFavoritoCC datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(PagarTarjetaUniFavoritoCC.class).withProperties(transferencias);
    }
}
