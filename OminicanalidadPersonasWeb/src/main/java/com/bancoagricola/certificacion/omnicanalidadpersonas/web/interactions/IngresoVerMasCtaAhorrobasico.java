...
public class IngresoVerMasCtaAhorrobasico implements Interaction {
    private String cuenta;

    public IngresoVerMasCtaAhorrobasico(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public static IngresoVerMasCtaAhorrobasico inicio(String cuenta) {
        return Instrumented.instanceOf(IngresoVerMasCtaAhorrobasico.class).withProperties(cuenta);
    }
}
