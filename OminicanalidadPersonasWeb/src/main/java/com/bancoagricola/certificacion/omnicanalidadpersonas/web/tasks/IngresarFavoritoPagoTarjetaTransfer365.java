...
public class IngresarFavoritoPagoTarjetaTransfer365 implements Task {
    private List<Transferencias> datosTransferencias;

    public IngresarFavoritoPagoTarjetaTransfer365(List<Transferencias> datosDCA) {
    ...
    public static IngresarFavoritoPagoTarjetaTransfer365 inicio(List<Transferencias> datosTransferencias) {
        return Instrumented.instanceOf(IngresarFavoritoPagoTarjetaTransfer365.class).withProperties(datosTransferencias);
    }
}