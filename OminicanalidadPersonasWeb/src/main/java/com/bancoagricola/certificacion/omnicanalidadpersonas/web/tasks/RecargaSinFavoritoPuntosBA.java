...
public class RecargaSinFavoritoPuntosBA implements Task {
    private List<Transferencias> datosDCA;

    public RecargaSinFavoritoPuntosBA(List<Transferencias> datosDCA) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidaTicketRecargasPuntosBA.datosCorrectos(datosDCA));
    }

    public static RecargaSinFavoritoPuntosBA datosCA(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(RecargaSinFavoritoPuntosBA.class).withProperties(datosDCA);
    }
}