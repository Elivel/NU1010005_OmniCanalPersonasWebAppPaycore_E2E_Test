...
public class MovimientosUltimosSeisMeses implements Interaction {
    ...
    public static MovimientosUltimosSeisMeses datosCA() {
        return Instrumented.instanceOf(MovimientosUltimosSeisMeses.class).withProperties();
    }
}
