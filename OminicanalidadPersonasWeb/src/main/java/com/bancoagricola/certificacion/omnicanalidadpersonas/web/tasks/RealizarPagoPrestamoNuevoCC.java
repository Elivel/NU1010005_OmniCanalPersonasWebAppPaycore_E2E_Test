...
public class RealizarPagoPrestamoNuevoCC implements Task {
    private List<Transferencias> datostransferencias;

    public RealizarPagoPrestamoNuevoCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarPagoPrestamoNuevoCC tercero(List<Transferencias> datosTransferencias) {
        return Instrumented.instanceOf(RealizarPagoPrestamoNuevoCC.class).withProperties(datosTransferencias);
    }
}
