...
import com.bancoagricola.certificacion.omnicanalidadpersonas.web.interactions.IngresoMenuADSMovimientosBasico;
...
public class CapturarSaldoCtaOrigenADS implements Task {

    private String cuenta;
    public CapturarSaldoCtaOrigenADS(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(IngresoMenuADSMovimientosBasico.inicio(cuenta));
    ...
    public static CapturarSaldoCtaOrigenADS transferencia(String cuenta) {
        return Instrumented.instanceOf(CapturarSaldoCtaOrigenADS.class).withProperties(cuenta);
    }
}
