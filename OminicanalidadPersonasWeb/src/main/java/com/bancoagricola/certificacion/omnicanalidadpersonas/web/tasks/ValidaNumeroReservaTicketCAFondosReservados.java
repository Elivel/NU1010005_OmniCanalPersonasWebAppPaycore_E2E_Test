...
import static com.bancoagricola.certificacion.omnicanalidadpersonas.web.userinterface.CuentasPage.TABLA_MOV_CA_FONDOS_RESERV;
...
public class ValidaNumeroReservaTicketCAFondosReservados implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(OTROS));
        WaitUntil.the(TABLA_MOV_CA_FONDOS_RESERV, isVisible()).forNoMoreThan(60).seconds().performAs(actor);
    ...
    public static ValidaNumeroReservaTicketCAFondosReservados conLaReferencia() {
        return Instrumented.instanceOf(ValidaNumeroReservaTicketCAFondosReservados.class).withProperties();
    }
}