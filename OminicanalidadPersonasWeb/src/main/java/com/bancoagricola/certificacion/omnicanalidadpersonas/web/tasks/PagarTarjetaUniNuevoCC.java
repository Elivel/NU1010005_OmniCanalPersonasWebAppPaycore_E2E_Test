...
public class PagarTarjetaUniNuevoCC implements Task {

    private List<Transferencias> transferencias;

    public PagarTarjetaUniNuevoCC(List<Transferencias> transferencias) {
    ...
    public static PagarTarjetaUniNuevoCC datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(PagarTarjetaUniNuevoCC.class).withProperties(transferencias);
    }
}
