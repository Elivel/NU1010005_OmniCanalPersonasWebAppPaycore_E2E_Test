...
public class CapturaComprobanteAhorroMetaNuevo implements Task {
    private List<Meta> datosMeta;

    public CapturaComprobanteAhorroMetaNuevo(List<Meta> datosMeta) {
        this.datosMeta = datosMeta;
    }

    public static CapturaComprobanteAhorroMetaNuevo Ticket(List<Meta> datosmeta) {
        return Instrumented.instanceOf(CapturaComprobanteAhorroMetaNuevo.class).withProperties(datosmeta);
