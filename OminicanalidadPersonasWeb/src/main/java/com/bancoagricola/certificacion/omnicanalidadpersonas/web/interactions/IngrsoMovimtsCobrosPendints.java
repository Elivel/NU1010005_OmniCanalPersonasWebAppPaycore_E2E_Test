...
public class IngrsoMovimtsCobrosPendints implements Interaction {
    ...
    public static IngrsoMovimtsCobrosPendints inicio(){
        return Instrumented.instanceOf(IngrsoMovimtsCobrosPendints.class).withProperties();
    }
}