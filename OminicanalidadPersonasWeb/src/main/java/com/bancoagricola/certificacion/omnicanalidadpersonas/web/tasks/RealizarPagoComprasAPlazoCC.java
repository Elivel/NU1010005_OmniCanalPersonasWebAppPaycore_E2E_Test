...
public class RealizarPagoComprasAPlazoCC implements Task {
    private List<Transferencias> datosCAP;

    public RealizarPagoComprasAPlazoCC(List<Transferencias> datosCAP) {
    ...
    public static RealizarPagoComprasAPlazoCC datosP(List<Transferencias> datosCAP) {
        return Instrumented.instanceOf(RealizarPagoComprasAPlazoCC.class).withProperties(datosCAP);
    }
}
