...
public class IngresoMenuADSMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoMenuADSMovimientos(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public static IngresoMenuADSMovimientos inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoMenuADSMovimientos.class).withProperties(datosDCA);
    }
}
