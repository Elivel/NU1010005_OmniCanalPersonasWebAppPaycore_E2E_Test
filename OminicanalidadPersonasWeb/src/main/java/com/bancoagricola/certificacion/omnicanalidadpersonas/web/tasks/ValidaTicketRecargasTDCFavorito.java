...
public class ValidaTicketRecargasTDCFavorito implements Task {

    private List<Transferencias> transferencias;

    public ValidaTicketRecargasTDCFavorito(List<Transferencias> transferencias) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        Task.where(actor+" valida que 'Desde' sea igual a "+"'"+t.getTarjetaCredito()+"'",  Ensure.that(DESDE_TICKET_CEL_FAV.resolveFor(actor).getAttribute(TEXT_CONTENT)).contains(t.getTarjetaCredito())).performAs(actor);
    ...
    public static ValidaTicketRecargasTDCFavorito datosCorrectos(List<Transferencias> transferencias) {
        return Instrumented.instanceOf(ValidaTicketRecargasTDCFavorito.class).withProperties(transferencias);
    }
}
