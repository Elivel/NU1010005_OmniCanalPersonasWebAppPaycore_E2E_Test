...
public class RealizarTransferenciaTerceroFavoritoCelularADS implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroFavoritoCelularADS(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaTerceroFavoritoCelularADS favorito(List<Transferencias> datostransferencias) {

        return Instrumented.instanceOf(RealizarTransferenciaTerceroFavoritoCelularADS.class).withProperties(datostransferencias);
    }
}