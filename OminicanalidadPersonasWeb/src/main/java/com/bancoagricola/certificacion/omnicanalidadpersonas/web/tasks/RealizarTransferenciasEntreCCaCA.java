...
public class RealizarTransferenciasEntreCCaCA implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciasEntreCCaCA(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciasEntreCCaCA cuentasPropias(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(RealizarTransferenciasEntreCCaCA.class).withProperties(datostransferencias);
    }
