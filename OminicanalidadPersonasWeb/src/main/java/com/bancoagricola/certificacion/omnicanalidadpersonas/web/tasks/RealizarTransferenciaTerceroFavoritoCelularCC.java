...
public class RealizarTransferenciaTerceroFavoritoCelularCC implements Task {

    private List<Transferencias> datostransferencias;

    public RealizarTransferenciaTerceroFavoritoCelularCC(List<Transferencias> datostransferencias) {
    ...
    public static RealizarTransferenciaTerceroFavoritoCelularCC favorito(List<Transferencias> datostransferencias) {

        return Instrumented.instanceOf(RealizarTransferenciaTerceroFavoritoCelularCC.class).withProperties(datostransferencias);
    }
}