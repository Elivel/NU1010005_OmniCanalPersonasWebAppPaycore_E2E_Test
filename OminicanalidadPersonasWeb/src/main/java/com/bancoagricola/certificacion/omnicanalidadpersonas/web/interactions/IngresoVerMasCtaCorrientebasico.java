...
public class IngresoVerMasCtaCorrientebasico implements Interaction {
    private String cuenta;

    public IngresoVerMasCtaCorrientebasico(String cuenta) {
        this.cuenta = cuenta;
    }
    ...
    public static IngresoVerMasCtaCorrientebasico inicio(String cuenta) {
        return Instrumented.instanceOf(IngresoVerMasCtaCorrientebasico.class).withProperties(cuenta);
    }
}
