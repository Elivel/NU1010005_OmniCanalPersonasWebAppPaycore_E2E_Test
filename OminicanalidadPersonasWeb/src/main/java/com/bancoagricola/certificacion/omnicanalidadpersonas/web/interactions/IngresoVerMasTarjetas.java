...
public class IngresoVerMasTarjetas implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoVerMasTarjetas(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public static IngresoVerMasTarjetas inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoVerMasTarjetas.class).withProperties(datosDCA);
    }
}
