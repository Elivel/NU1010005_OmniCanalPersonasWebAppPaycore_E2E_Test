...
public class CapturarSaldoInicialTcCta implements Task {

    private List<Transferencias> datostransferencias;

    public CapturarSaldoInicialTcCta(List<Transferencias> datostransferencias) {
    ...
    public static CapturarSaldoInicialTcCta transferenciaTarjeta(List<Transferencias> datostransferencias) {
        return Instrumented.instanceOf(CapturarSaldoInicialTcCta.class).withProperties(datostransferencias);
    }
}
