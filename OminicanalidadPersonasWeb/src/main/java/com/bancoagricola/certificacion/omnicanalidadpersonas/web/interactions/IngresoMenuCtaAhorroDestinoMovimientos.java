...
public class IngresoMenuCtaAhorroDestinoMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoMenuCtaAhorroDestinoMovimientos(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public static IngresoMenuCtaAhorroDestinoMovimientos inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoMenuCtaAhorroDestinoMovimientos.class).withProperties(datosDCA);
    }
}