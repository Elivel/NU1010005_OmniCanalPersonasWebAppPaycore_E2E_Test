...
public class RealizarPagoTarjetaCreditoPropiaTarjetas implements Task {
    private List<Transferencias> datostransferencias;

    public RealizarPagoTarjetaCreditoPropiaTarjetas(List<Transferencias> datostransferencias) {
    ...
    public static RealizarPagoTarjetaCreditoPropiaTarjetas datosCompletos(List<Transferencias> datosTransferencias) {
        return Instrumented.instanceOf(RealizarPagoTarjetaCreditoPropiaTarjetas.class).withProperties(datosTransferencias);
    }
}
