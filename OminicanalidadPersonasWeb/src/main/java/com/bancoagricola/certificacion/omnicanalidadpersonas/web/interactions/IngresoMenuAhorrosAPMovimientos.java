...
public class IngresoMenuAhorrosAPMovimientos implements Interaction {

    private List<Transferencias> datosTransferencias;
    public IngresoMenuAhorrosAPMovimientos(List<Transferencias> datosDCA) { this.datosTransferencias = datosDCA;}
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(LINK_VER_MAS_METAS2.of(t.getCuentaOrigen()),isVisible()).forNoMoreThan(60).seconds(),
                Click.on(LINK_VER_MAS_METAS2.of(t.getCuentaOrigen())),
    ...
    public static IngresoMenuAhorrosAPMovimientos inicio(List<Transferencias> datosDCA){
        return Instrumented.instanceOf(IngresoMenuAhorrosAPMovimientos.class).withProperties(datosDCA);
    }
}
