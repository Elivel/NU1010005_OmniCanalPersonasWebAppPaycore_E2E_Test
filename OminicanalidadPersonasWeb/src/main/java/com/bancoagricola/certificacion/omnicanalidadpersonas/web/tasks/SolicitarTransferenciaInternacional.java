...
public class SolicitarTransferenciaInternacional implements Task {
    ...
    public static SolicitarTransferenciaInternacional inicio() {
    return Instrumented.instanceOf(SolicitarTransferenciaInternacional.class).withProperties();
    }
}
