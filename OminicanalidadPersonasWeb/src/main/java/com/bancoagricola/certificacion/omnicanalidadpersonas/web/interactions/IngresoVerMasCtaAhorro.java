...
public class IngresoVerMasCtaAhorro implements Interaction {

    private List<Transferencias> datosTransferencias;

    public IngresoVerMasCtaAhorro(List<Transferencias> datosDCA) {
    ...
    public static IngresoVerMasCtaAhorro inicio(List<Transferencias> datosDCA) {
        return Instrumented.instanceOf(IngresoVerMasCtaAhorro.class).withProperties(datosDCA);
    }
}
