...
Característica: El cliente podrá realizar recarga y compra de paquetes desde TDC para Claro

  @RecargaCompraPaquetesTarjetas @DEV
  Esquema del escenario: El cliente podrá realizar recargas y compra de paquetes a través de TDC
    ...
    Ejemplos:
      ...
      | **** 4045 VISA Selectos Clásica 3 | 70116088 | CLARO, PREPAGO (RECARGA) | SUPERPACK TODO INCLUIDO M POR 7 DIAS $ 30.00 | recarga/paquete | FavoritoPaqC3  | Recarga de Celular | 60    |
      | **** 4045 VISA Selectos Clásica 3 | 70116088 | CLARO, PREPAGO (RECARGA) | $ 1.00                                       | recarga/paquete | FavoritoPaqC3  | Recarga de Celular | 2     |