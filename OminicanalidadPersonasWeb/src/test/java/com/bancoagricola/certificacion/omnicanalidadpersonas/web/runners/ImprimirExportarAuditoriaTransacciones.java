...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Imprimir_Exportar/imprimir_exportar_auditoria_transacciones.feature",
...
public class ImprimirExportarAuditoriaTransacciones {
}
