...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Consulta_Movimientos/consulta_movimientos_ahorro_programado.feature",
...
public class ConsultaMovimientosAhorroProgramado {
}
