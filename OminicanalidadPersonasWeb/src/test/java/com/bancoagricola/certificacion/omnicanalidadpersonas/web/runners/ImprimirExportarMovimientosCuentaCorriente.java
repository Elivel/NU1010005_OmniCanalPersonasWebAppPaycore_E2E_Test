...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Imprimir_Exportar/imprimir_exportar_movimientos_cuenta_corriente.feature",
...
public class ImprimirExportarMovimientosCuentaCorriente {
}
