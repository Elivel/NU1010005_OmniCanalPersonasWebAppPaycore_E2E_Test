...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Consulta_Movimientos/consulta_movimientos_extrafinanciamiento.feature",
...
public class ConsultaMovimientosExtrafinanciamiento {
}
