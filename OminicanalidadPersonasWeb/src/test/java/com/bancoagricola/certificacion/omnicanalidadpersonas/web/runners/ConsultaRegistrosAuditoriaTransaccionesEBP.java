...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Consultas/consulta_registros_auditoria_transacciones_EBP.feature",
...
public class ConsultaRegistrosAuditoriaTransaccionesEBP {
}
