...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Solicitudes/solicitud_eliminacion_estado_cuenta_via_email.feature",
...
public class SolicitudEliminacionEstadoCuentaViaEmail {
}
