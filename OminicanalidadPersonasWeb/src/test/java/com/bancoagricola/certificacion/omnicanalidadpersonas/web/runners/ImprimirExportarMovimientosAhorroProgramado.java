...
@CucumberOptions(
        plugin = {"pretty"},
        features = "src/test/resources/features/Imprimir_Exportar/imprimir_exportar_movimientos_ahorro_programado.feature",
...
public class ImprimirExportarMovimientosAhorroProgramado {
}
